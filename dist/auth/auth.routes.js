...
router.get('/api/admin/getUser/:id', auth_middleware_1.verifyToken, AuthController.getUser);
router.put('/api/admin/update/:id', auth_middleware_1.verifyToken, AuthController.updateUser);
